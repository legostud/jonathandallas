...
/* - ep_site.js - */
// http://www.everestpoker.es/portal_javascripts/ep_site.js?original=1
...
jq(function(){EP.init()});
function addVerticalSpacing(){if(!jq("#opmodule_body").length){var viewportHeight;if(typeof window.innerWidth!='undefined'){viewportHeight=window.innerHeight} else if(typeof document.documentElement!='undefined'&&typeof document.documentElement.clientWidth!='undefined'&&document.documentElement.clientWidth!=0){viewportHeight=document.documentElement.clientHeight} else{viewportHeight=document.getElementsByTagName('body')[0].clientHeight}
...
function bonusReceived(){var cookies=EP.read_cookies();jq(".screen-name").each( function(){var screen_name=cookies.screenname?cookies.screenname:window.location="invalid";jq(this).html(screen_name)});jq(".bonus-code").each( function(){var bonus_code=cookies.bonuscode?cookies.bonuscode:window.location="invalid";jq(this).html(bonus_code)})}
