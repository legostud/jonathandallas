<table dir="ltr" width="100%" cellpadding="0" cellspacing="5" border="0" class="cssBody"><tr><td>
	...
	<p>Fra våre sjenerøse velkomstbonuser til vår spennende månedlige konkurranse til ekstra kampanjer. Hver hendelse hos <TMPL_VAR CASINO_NAME>&#153; inneholder spennende konkurranser og fantastiske muligheter til å vinne. Bruk din flaks, ferdighet eller begge til å vinne store premier!</p>
